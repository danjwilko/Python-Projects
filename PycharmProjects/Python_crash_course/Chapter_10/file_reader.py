...
# two newline charaters at the end of each line: one from the file and one from the print(). Using rstrip() on each line
# in the print() call we can eliminate these extra blank lines.
